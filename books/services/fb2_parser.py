...
class FB2Parser:
    ...
    def parse(self):
        try:
            ...
            return {"title": title, "author": author, "cover": cover_data, "text": text}
    ...
    def _get_text(self, tree):
        ...
        # We'll convert the body to a string and wrap it in a div.
        # This is a simplified approach. A more robust solution would involve
        # XSLT transformation to convert FB2 to HTML.

        # Remove namespace prefixes for cleaner HTML
        ...
        etree.strip_elements(body, "binary", with_tail=False)

        return etree.tostring(body, encoding="unicode", method="html")

    def _extract_section_text(self, section):
        # This method is no longer used, but I'll keep it here for now.
        texts = []
